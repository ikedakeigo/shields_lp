      ...
      <div class="faq__inner inner">
        ...
        <ul class="p-faq__list p-faq-list l-img">
          ...
          <li class="p-faq-list__item">
            ...
            <p class="p-faq-list__item-answer">
              <span>A.</span>
              最後に出社した日に会社に置いてくると返却の手間も省けますが、もし手元にある場合はご本人から会社宛に郵送をお願い致します。<br />
          ...
          <li class="p-faq-list__item">
            ...
            <p class="p-faq-list__item-answer">
              <span>A.</span>
              訴えられるケースは今までで1度もございません<br />
              会社によってはそう脅してくる会社もあるかもしれません。<br />
          ...
          <li class="p-faq-list__item">
            ...
            <p class="p-faq-list__item-answer">
              <span>A.</span>
              これまでほとんどのケースで有給消化しての退職に成功しております<br />
